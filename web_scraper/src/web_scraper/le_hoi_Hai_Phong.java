...
public class le_hoi_Hai_Phong {
	public static void main(String[] args) {
		String url = "https://luhanhvietnam.com.vn/du-lich/le-hoi-o-hai-phong-mang-ban-sac-rieng.html";
	...
	private static void crawl(int level, String url, ArrayList<String> visited) {
		...
		Elements danh_sach = doc.select("ul ~ h3"); 
...
//			
//		}
		try (FileWriter file = new FileWriter("le_hoi_hai_phong.json")) {
